...
public final class BitcoinIntegration
{
	 ...
	 * received by overriding {@link android.app.Activity}. Result indicates either
	 ...
	 * @param requestCode
	 *            Code identifying the call when {@link android.app.Activity} is called back
	 * @param address
	 *            Bitcoin address
	 */
	 ...
	 * overriding {@link android.app.Activity}. Result indicates either {@link Activity#RESULT_OK} or
	 ...
	 * {@link android.app.Activity}. Result indicates either {@link Activity#RESULT_OK} or
	 * {@link Activity#RESULT_CANCELED}. In the success case, use {@link #transactionHashFromResult(Intent)} to read the
	 * transaction hash from the intent.
	 *
	 * Warning: A success indication is no guarantee! To be on the safe side, you must drive your own Bitcoin
